...
> **Non-goal**: Threat elimination—see [Threat Model](architecture-threat-model).
...
**See also**: [Threat Model](architecture-threat-model) | [Agent Lifecycle](business-agent-lifecycle) | [Infrastructure](architecture-infrastructure)
