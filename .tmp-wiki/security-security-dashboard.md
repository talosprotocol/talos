...
> **Non-goal**: Full SIEM replacement—see [Observability](features-observability-observability) for integration.
...
**See also**: [Audit Explorer](features-observability-audit-explorer) | [Observability](features-observability-observability) | [Schemas](api-schemas)
