...
> **Non-goal**: This is not comprehensive—see [Python SDK](sdk-python-sdk) for full API.
...
| Goal | Page |
|------|------|
| Understand the mental model | [Talos Mental Model](mental-model) |
| Learn all API methods | [Python SDK](sdk-python-sdk) |
| Secure MCP tools | [MCP Cookbook](features-integrations-mcp-cookbook) |
| Deploy to production | [Hardening Guide](guides-hardening-guide) |

---

> ⚠️ **Do not copy-paste to production**. This quickstart uses defaults suitable for development. See [Hardening Guide](guides-hardening-guide) for production configuration.
