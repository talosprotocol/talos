...
See [Non-Goals](reference-non-goals) for full list.
...
**Start here**: [Talos in 60 Seconds](getting-started-talos-60-seconds) | [Quickstart](getting-started-quickstart) | [MCP Cookbook](features-integrations-mcp-cookbook)
