...
export default function SessionsPage() {
    ...
    if (loading && sessionScores.length === 0) {
        return <div className="p-8 text-zinc-500">Loading sessions...</div>;
    }
    ...
    return (
        <main className="min-h-screen bg-[var(--bg)] p-8 font-sans text-zinc-100">
            <header className="mb-8">
                ...
                <p className="text-zinc-500 text-sm">Real-time threat analysis and suspicious activity scoring.</p>
            </header>
            ...
            <div className="grid grid-cols-1 gap-4">
                        ...
                        <GlassPanel variant="hoverable" className="p-4 flex items-center justify-between group cursor-pointer">
                            <div className="flex items-center gap-4">
                                <div className="flex flex-col">
                                    <div className="text-sm font-mono font-semibold text-zinc-200 group-hover:text-[var(--accent)] transition-colors">
                                        {session.sessionId}
                                    </div>
                            ...
                            <div className="flex items-center gap-8">
                                ...
                                <div className="text-right">
                                    <div className="text-[10px] uppercase text-zinc-500 font-bold tracking-wider">Risk Score</div>
                ...
                {sessionScores.length === 0 && (
                    <div className="text-center py-10 text-zinc-600">No active sessions found.</div>
                )}
            </div>
        </main>
    )
