...
export default function GatewayPage() {
    ...
    if (loading || !gatewayStatus) {
        return <div className="p-8 text-zinc-500">Loading gateway status...</div>;
    }
    ...
    return (
        <main className="min-h-screen bg-[var(--bg)] p-8 font-sans text-zinc-100">
            <header className="mb-8">
                ...
                <p className="text-zinc-500 text-sm">Infrastructure health and resource monitoring.</p>
            </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <StatusCard
                    ...
                    icon={<Server className="text-zinc-500" />}
                />
                <StatusCard
                    label="Uptime"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <GlassPanel className="p-6">
                    ...
                    <div className="space-y-6">
                        <div>
                            <div className="text-xs text-zinc-500 uppercase font-bold tracking-wider mb-1">Active Sessions</div>
                            <div className="text-3xl font-mono font-bold">{gatewayStatus.sessions.active_sessions}</div>
                        </div>
                        <div>
                            <div className="text-xs text-zinc-500 uppercase font-bold tracking-wider mb-1">Replay Rejections (1h)</div>
            ...
            <div className="mt-8">
                <GlassPanel className="p-4 text-xs font-mono text-zinc-500 flex justify-between">
...
function StatusCard({ label, value, icon }: { label: string, value: string, icon: any }) {
    return (
...
function StatRow({ label, value, highlight }: { label: string, value: number, highlight?: boolean }) {
    return (
        <div>
            ...
            <div className={`font-mono font-bold text-lg ${highlight ? "text-emerald-500" : "text-zinc-300"}`}>
...
function ClockIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-500 w-4 h-4"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>
    )
}
